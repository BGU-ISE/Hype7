...
(async () => {
   // try {
        const videoMeta = await getVideoMeta('https://www.tiktok.com/@.masteroogway_official/video/7042793566820781314', {});
        console.log(videoMeta);
   // } catch (error) {
   //     console.log("why");
   //     console.log(error);
  //  }
    console.log("well im out");
})();
/*
var dy = new Date("2019-11-13");
console.log('day:' + dy.getDate() + '    month' + dy.getUTCMonth()+1 + '     year' + dy.getFullYear());
console.log(dy.getUTCMonth())
*/
/**
 * Output example
 */
