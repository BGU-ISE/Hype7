...
namespace Scraper_Manager
{
    class Program
    {
        ...
        static List<string> load_history()
        {
            List<string> ans = new List<string>();
          
            using (var reader = new StreamReader("../../../input_folder/history.txt"))
            {
        ...
        static void add_to_history(string file_name)
        {
            using (var w = File.AppendText("../../../input_folder/history.txt"))
            {
